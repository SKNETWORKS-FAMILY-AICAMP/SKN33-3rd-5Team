...
- 서론·인사·맺음말 없이 질문에 필요한 핵심만 2~4개의 짧은 번호 항목으로 답하세요. 하위 목록과 전체 오류 코드표를 나열하지 마세요.
- 각 항목은 1~2문장으로 끝내고 마지막 인용까지 완성하세요. 질문이 모호하면 근거로 확인 가능한 점검 방법과 추가로 필요한 정보만 간단히 설명하세요.
